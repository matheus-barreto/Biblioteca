...
public class ConsultaLivro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Título", "Editora"}));
    ...
    private void MostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MostrarActionPerformed
        try {
            ...
            if (busca.getText().equals("")) {
                ...
                if (tipo.getSelectedItem().toString().equals("Título")) {
                    ResultSet rs = dv.stmt.executeQuery("Select O.titulo, L.edicao, E.nome_fantasia from obra O, livro L, editora E where (O.nr_obra=L.nr_livro) and (L.id_editora=E.id_editora) and O.titulo Like '%" + busca.getText() + "%'");
                    while (rs.next()) {
                        String[] linha = new String[]{rs.getString("titulo"), rs.getString("edicao"), rs.getString("nome_fantasia")};
                        tabModel.addRow(linha);
                    }
                }  else {
                    ResultSet rs = dv.stmt.executeQuery("Select O.titulo, L.edicao, E.nome_fantasia from obra O, livro L, editora E where (O.nr_obra=L.nr_livro) and (L.id_editora=E.id_editora) and E.nome_fantasia Like '%" + busca.getText() + "%'");
                    while (rs.next()) {
                        String[] linha = new String[]{rs.getString("titulo"), rs.getString("edicao"), rs.getString("nome_fantasia")};
                        tabModel.addRow(linha);
                    }
